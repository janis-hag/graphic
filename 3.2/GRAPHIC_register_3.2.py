...
## parser.add_argument('--center_file', action="store", dest="center_file", default=None, help='Centroids file generated by the SPHERE pipeline.')
...
if rank==0:  # Master process
	...
	for i in range(len(dirlist)):
		...
		if no_psf:
			...
			cent_list[:,1]=cube.shape[1]/2. # X center
			cent_list[:,2]=cube.shape[2]/2. # Y center
			del cube
		else:
			sat=-1
			if nosat:
