...
if rank==0:
	...
	def cut_and_center_cub(file_name):
	    """
	    ...
	    #finding the position of the mask after translation of the image
	    #left mask
	...
	length=0
	#key_word="cl_nomed_SPHER.2015-06-07T00_56_29.062IRD_FLUX_*"
