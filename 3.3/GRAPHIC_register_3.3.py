...
parser.add_argument('--smooth_width', action="store", dest="smooth_width", type=float,
    default=3, help='The std dev of the Gaussian kernel used to smooth the data before measuring the centre')
parser.add_argument('--psf_width', action="store", dest="psf_width", type=float, default=3, help='An initial guess for the psf width')
...
parser.add_argument('-once_per_cube', dest='once_per_cube', action='store_const',
                   const=True, default=False,
...
parser.add_argument('-nirc2', dest='nirc2', action='store_const',
                   const=True, default=False,
                   help='Switch for NIRC2 data')
...
parser.add_argument('-agpm_centre', action='store_const', dest='agpm_centre',
                    const=True, default=False,
                    help='Use the double-Gaussian fit for AGPM coronagraph images. Positive Gaussian for star, negative Gaussian for coro.')
parser.add_argument('-remove_striping', action='store_const', dest='remove_striping',
                    const=True, default=False,
                    help='Remove the median of each row before calculating the centre position')
