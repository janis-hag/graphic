...
parser = argparse.ArgumentParser(
        description='Cleans HICAO images using the destripe routine')
parser.add_argument('--pattern', action="store", dest="pattern", required=True,
                    help='Filename pattern')
parser.add_argument('--flat', action="store", dest="flat_file", required=True,
                    help='Domeflat file including path')
