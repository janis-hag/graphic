...
if rank==0:
    ...
    if nici:
        print('--pattern '+psf_sub_filename.split('_S')[0]+' --info_pattern '+info_filename.split('_S')[0])
    elif sphere:
        print('--pattern '+psf_sub_filename.split('SPHER')[0]+' --info_pattern '+info_filename.split('SPHER')[0])
    elif scexao:
        print('--pattern '+psf_sub_filename.split('HIC')[0]+' --info_pattern '+info_filename.split('HIC')[0])
    else:
        print('--pattern '+psf_sub_filename.split('NACO')[0]+' --info_pattern '+info_filename.split('NACO')[0])
    sys.exit(0)
