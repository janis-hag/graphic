...
if rank==0:
	...
	t_init=MPI.Wtime()
	dirlist=graphic_nompi_lib.create_dirlist(pattern,target_pattern=target_pattern+"_")
	...
	if args.stat==True:
		print("\n STAT: Stack preparation took: "+graphic_nompi_lib.humanize_time(MPI.Wtime()-tb))
		tb=MPI.Wtime()
		t0_trans=MPI.Wtime()
	...
	if args.stat==True:
		print("\n STAT: Data upload took: "+graphic_nompi_lib.humanize_time(MPI.Wtime()-t0_trans))
	...
	if args.stat==True:
		print("\n STAT: Data download took: "+graphic_nompi_lib.humanize_time(MPI.Wtime()-t0_trans))
		print("\n STAT: Median calculation took: "+graphic_nompi_lib.humanize_time(MPI.Wtime()-tb))
	...
	graphic_nompi_lib.save_fits(median_filename, med, target_dir=target_dir, hdr=hdr, backend='pyfits')

	sys.stdout.write("\n Saved: {name} .\n Processed in {human_time} at {rate:.2f} MB/s \n"
						 .format(name=median_filename, human_time=graphic_nompi_lib.humanize_time(MPI.Wtime()-t0_cube) ,
