...
if rank==0:  # Master process
	...
	dirlist=graphic_lib_310.create_dirlist(source_dir+os.sep+pattern,target_dir=target_dir, target_pattern=file_prefix)
...
for i in range(len(dirlist)):
	...
	print(str(rank)+': ['+str(i+1)+"/"+str(len(dirlist))+"] "+dirlist[i]+" Remaining time: "+graphic_lib_310.humanize_time((MPI.Wtime()-t0)*(len(dirlist)-i)/(i+1-skipped)))
